...
Gem::Specification.new do |s|
  ...
  s.files = [".yardopts", "CHANGELOG.md", "CONTRIBUTING.md", "LICENSE.md", "README.md", "Rakefile", "multi_json.gemspec", "Gemfile", ".document", ".rspec", ".travis.yml", "spec/adapter_shared_example.rb", "spec/helper.rb", "spec/json_common_shared_example.rb", "spec/multi_json_spec.rb", "lib/multi_json/adapters/gson.rb", "lib/multi_json/adapters/json_common.rb", "lib/multi_json/adapters/json_gem.rb", "lib/multi_json/adapters/json_pure.rb", "lib/multi_json/adapters/nsjsonserialization.rb", "lib/multi_json/adapters/oj.rb", "lib/multi_json/adapters/ok_json.rb", "lib/multi_json/adapters/yajl.rb", "lib/multi_json/vendor/okjson.rb", "lib/multi_json/version.rb", "lib/multi_json.rb"]
